...
export const oemdesignname = randomDesignName;
...
describe("RA buyer", () => {
  ...
  it("Searches for the Uploaded theme and share it with a vendor", () => {
    cy.visit("https://platform.impetusz0.de/auth/login", { timeout: 20000 });
    ...
    cy.get("div.side-navigation-panel-select-inner-option", { timeout: 5000 })
      ...
      .click()
      .wait(15000);
    cy.get('input[placeholder="Search"]').type(oemdesignname);
  ...
  it("Verify that shared Inspiration is visible and submit design", () => {
    cy.visit("https://platform.impetusz0.de/auth/login").wait(10000);
    ...
    cy.get("div.side-navigation-panel-select-inner-option", { timeout: 5000 })
      ...
      .click()
      .wait(15000);
    cy.get('input[placeholder="Search"]').type(oemdesignname).wait(1000);
  ...
  it("Cluster rejects submitted design", () => {
    ...
    cy.contains("div", "Cost not viable").first().click({ force: true });
